...
def student_screen():
    ...
    with c1:
        header_dashboard()
    with c2:
        if st.button("Go Back To Home", type='secondary',key='gobackbtn',shortcut="control+backspace"):
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name=st.text_input("Enter your name",placeholder='E.g. Faizanur Rahman')
            ...
            try:
                audio_data=st.audio_input('Record a short phrase like I am present ,My name is faizan.')
            except Exception:
                ...
                if new_name:
                    with st.spinner('Creating profile..'):
                        ...
                        if encodings:
                            ...
                            st.error('Couldnt capture your facial featurs for registration')
